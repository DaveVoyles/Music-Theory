...
export const FEATURE_HELP = {
  ...
  romanStrip: {
    ...
    how: 'Selecting a degree filters the fretboard to that chord’s tones. “All” or tapping the same degree again clears the filter so every diatonic note shows again.',
    tryThis: 'In C major, tap V — only G, B, and D should stay bright on the neck.',
  },
  minorForm: {
    title: 'Minor form',
